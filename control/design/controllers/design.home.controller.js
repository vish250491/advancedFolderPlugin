    ...
    angular
        ...
        .controller('DesignHomeCtrl', ['$scope', '$timeout', 'COLLECTIONS', 'DB', 'DEFAULT_DATA', 'Buildfire',
            function ($scope, $timeout, COLLECTIONS, DB, DEFAULT_DATA, Buildfire) {
                ...
                var DesignHome = this;
                var timerDelay;
                DesignHome.layouts = [{name: "list-layout1"}, {name: "list-layout2"}, {name: "list-layout3"}, {name: "list-layout4"}, {name: "list-layout5"}, {name: "list-layout6"}, {name: "list-layout7"}, {name: "list-layout8"}, {name: "list-layout9"}, {name: "list-layout10"}, {name: "list-layout11"}];
